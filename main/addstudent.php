          ...
          <form action="savestudent.php" method="post" enctype="multipart/form-data">
            ...
            <center>
              <div id="ac">
                ...
                <span>First Name : </span><input type="text" style="width:265px; height:30px;" name="name"
                  Required /><br>
                ...
                <span>Parent Phone: </span><input type="text" style="width:265px; height:30px;" name="parent"
                  required />
                <br>
